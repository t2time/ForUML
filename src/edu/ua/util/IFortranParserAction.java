...
public abstract interface IFortranParserAction {
   ...
   *
   * ERR_CHK 308 named_constant replaced by T_IDENT C302 R308 int_constant shall
   * be of type integer inlined integer portion of constant
   *
   * @param id The identifier representing the named constant if present,
   * otherwise is a literal-constant
   */
   ...
   * @param isExtended True if the token is an extended-intrinsic-op, otherwise
   ...
   */
  public abstract void intrinsic_type_spec(Token keyword1, Token keyword2, int type, boolean hasKindSelector);

  /**
   * R404 kind_selector : T_LPAREN (T_KIND T_EQUALS)? expr T_RPAREN | T_ASTERISK
   * T_DIGIT_STRING
   *
   * @param token1 KIND keyword token (or *, nonstandard usage)
   * @param token2 = token (or size of type, nonstandard usage)
   * @param hasExpression True if an expr is present (standard-confirming
   * option)
   */
  public abstract void kind_selector(Token token1, Token token2, boolean hasExpression);
  ...
  /**
   * R416 signed_real_literal_constant : (T_PLUS|T_MINUS)? real_literal_constant
   *
   * @param sign The sign: positive, negative, or null.
   */
   ...
   * type_param_value )? T_RPAREN | T_LPAREN type_param_value ( T_COMMA (T_KIND
   ...
   * @param kindOrLen1 Specifies whether the first kind or len type-param-value
   * is present
   ...
   */
  public abstract void char_selector(Token tk1, Token tk2, int kindOrLen1, int kindOrLen2, boolean hasAsterisk);
   ...
   * @param hasAsterisk True if a '*' char-selector is specified
   */
  public abstract void length_selector(Token len, int kindOrLen, boolean hasAsterisk);
   ...
   * @param kindParam The kind parameter
   */
  public abstract void logical_literal_constant(Token logicalValue, boolean isTrue, Token kindParam);
   ...
   */
  public abstract void derived_type_stmt(Token label, Token keyword, Token id, Token eos,
   ...
   * (Weird spelling of extnds and abstrct avoids overrriding java keywords.)
   */
   ...
   * @param typeKeyword Token for T_TYPE, if given as a separate token. null if
   * not provided.
   * @param id The identifier.
   * @param eos T_EOS token.
   */
  public abstract void end_type_stmt(Token label, Token endKeyword, Token typeKeyword, Token id, Token eos);
  ...
  /**
   * R436 list type_param_decl type_param_decl_list : type_param_decl ( T_COMMA
   * type_param_decl )*
   *
   * @param count The number of items in the list.
   */
  ...
  /**
   * R439 component_def_stmt : data_component_def_stmt | proc_component_def_stmt
   *
   ...
   */
  public abstract void component_decl(Token id, boolean hasComponentArraySpec, boolean hasCoarraySpec,
   ...
   *
   * @param isExplicit True if this is an explicit shape spec list. false if it
   * is a deferred shape spec list.
   */
   ...
   * access_spec
   */
  public abstract void proc_component_attr_spec(Token attrSpecKeyword, Token id, int specType);

  /**
   * R446 list proc_component_attr_spec_list proc_component_attr_spec ( T_COMMA
   ...
   * @param eos T_EOS token.
   */
  public abstract void private_components_stmt(Token label, Token privateKeyword, Token eos);
   ...
   */
  public abstract void type_bound_procedure_part(int count, boolean hasBindingPrivateStmt);
   ...
   * @param eos T_EOS token.
   */
  public abstract void binding_private_stmt(Token label, Token privateKeyword, Token eos);
   ...
   */
  public abstract void specific_binding(Token procedureKeyword, Token interfaceName, Token bindingName,
  ...
  /**
   * R456 list type_param_spec_list : type_param_spec ( T_COMMA type_param_spec
   * )*
   *
   * @param count The number of items in the list.
   */
   ...
   * @param eos T_EOS token.
   */
  public abstract void enum_def_stmt(Token label, Token enumKeyword, Token bindKeyword, Token id, Token eos);
   ...
   * @param eos T_EOS token.
   */
  public abstract void enumerator_def_stmt(Token label, Token enumeratorKeyword, Token eos);
  ...
  /**
   * R464 end_enum_stmt : (label)? T_END T_ENUM T_EOS | (label)? T_ENDENUM T_EOS
   *
   * @param label The label.
   ...
   * @param eos T_EOS token.
   */
  public abstract void end_enum_stmt(Token label, Token endKeyword, Token enumKeyword, Token eos);
   ...
   */
  public abstract void type_declaration_stmt(Token label, int numAttributes, Token eos);
  ...
  /**
   * R503 attr_spec : access_spec | T_ALLOCATABLE | T_ASYNCHRONOUS | T_DIMENSION
   * T_LPAREN array_spec T_RPAREN | T_EXTERNAL | T_INTENT T_LPAREN intent_spec
   * T_RPAREN | T_INTRINSIC | language_binding_spec | T_OPTIONAL | T_PARAMETER |
   * T_POINTER | T_PROTECTED | T_SAVE | T_TARGET | T_VALUE | T_VOLATILE
   *
   * @param attrKeyword Token for the keyword of the given attribute. Will be
   * null in the cases of access_sepc and language_binding_spec.
   ...
   */
  public abstract void entity_decl(Token id, boolean hasArraySpec, boolean hasCoarraySpec,
  ...
  /**
   * R509 language_binding_spec : T_BIND T_LPAREN T_IDENT (T_COMMA name T_EQUALS
   * expr)? T_RPAREN
   *
   ...
   */
  public abstract void language_binding_spec(Token keyword, Token id, boolean hasName);

  /**
   * R509-F08 coarray_spec : deferred_coshape_spec_list | explicit_coshape_spec
   *
   ...
   * This token can ONLY be T_OUT in the case of "intent(in out)", and must be
   * null for all other intents.
   * @param intent The type of intent-spec.
   */
  public abstract void intent_spec(Token intentKeyword1, Token intentKeyword2, int intent);

  /**
   * R518 access_stmt : (label)? access_spec ((T_COLON_COLON)? access_id_list)?
   * T_EOS
   *
   * @param label The label.
   * @param eos End of statement token.
   ...
   */
  public abstract void allocatable_decl(Token id, boolean hasArraySpec, boolean hasCoarraySpec);
  ...
  /**
   * R524 data_stmt : (label)? T_DATA data_stmt_set ((T_COMMA)? data_stmt_set)*
   * T_EOS
   *
   * @param label The label.
   ...
   */
  public abstract void data_stmt(Token label, Token keyword, Token eos, int count);
   ...
   * @param hasThirdExpr Flag to specify if optional third expression was given.
   * True if expression given; false if not.
   */
  ...
  /**
   * R530 list data_stmt_value_list : data_stmt_value ( T_COMMA data_stmt_value
   * )*
   *
   * @param count The number of items in the list.
   */
  ...
  /**
   * R535 dimension_stmt (label)? T_DIMENSION ( T_COLON_COLON )? dimension_decl
   ...
   */
  public abstract void dimension_stmt(Token label, Token keyword, Token eos, int count);
  ...
  /**
   * R538 parameter_stmt : (label)? T_PARAMETER T_LPAREN named_constant_def_list
   * T_RPAREN T_EOS
   *
   * @param label The label.
  ...
  /**
   * R540 pointer_stmt : (label)? T_POINTER ( T_COLON_COLON )? pointer_decl_list
   * T_EOS
   *
   * @param label The label.
   ...
   */
  public abstract void save_stmt(Token label, Token keyword, Token eos, boolean hasSavedEntityList);
  ...
  /**
   * R557-F08 target_decl : T_IDENT (T_LPAREN array_spec T_RPAREN)? (T_LBRACKET
   * coarray_spec T_RBRACKET)?
   *
   * @param objName The name of the object
   * @param hasArraySpec True if has an array spec.
   * @param hasCoarraySpec True if has a co array spec.
   */
  public abstract void target_decl(Token objName, boolean hasArraySpec, boolean hasCoarraySpec);
   ...
   */
  public abstract void implicit_stmt(Token label, Token implicitKeyword, Token noneKeyword,
   ...
   */
  public abstract void namelist_stmt(Token label, Token keyword, Token eos, int count);
   ...
   * @param eos T_EOS token.
   */
  public abstract void equivalence_stmt(Token label, Token equivalenceKeyword, Token eos);
  ...
  /**
   * R555 list equivalence_set_list : equivalence_set ( T_COMMA equivalence_set
   * )*
   *
   * @param count The number of items in the list.
   */
   ...
   */
  public abstract void common_stmt(Token label, Token commonKeyword, Token eos, int numBlocks);
   ...
   * data_ref allows it to match T_LPAREN substring_range T_RPAREN, so required
   * T_LPAREN substring_range T_RPAREN made optional ERR_CHK 609 ensure final ()
   * is (substring-range)
   *
  ...
  /**
   * R619 (see R1220, actual_arg_spec) section_subscript/actual_arg_spec : expr
   * section_subscript_suffix | T_COLON (expr)? (T_COLON expr)? | T_COLON_COLON
   * expr | T_IDENT T_EQUALS (expr | T_ASTERISK label ) | T_ASTERISK label //
   * could be an actual-arg-spec, see R1220 | { // empty could be an actual-arg,
   * see R1220 // }
   *
   ...
   */
  public abstract void section_subscript(boolean hasLowerBound, boolean hasUpperBound,
   ...
   * type_spec T_COLON_COLON allocation_list (T_COMMA alloc_opt_list)? T_RPAREN
   * T_EOS | (label)? T_ALLOCATE T_LPAREN allocation_list (T_COMMA
   ...
   */
  public abstract void allocate_stmt(Token label, Token allocateKeyword, Token eos,
  ...
  /**
   * R628, R631-F2008 allocation : ( T_LPAREN allocate_shape_spec_list T_RPAREN
   * )? ( T_LBRACKET allocate_coarray_spec T_RBRACKET )?
   *
   * NOTE: In current parser, hasAllocateShapeSpecList is always false, appears
   * as R619 section-subscript-list. In a section-subscript, the stride shall
   * not be present and if hasUpperBound is false, hasLowerBound shall be
   * present and must be interpreted as an upper-bound-expr.
   *
  ...
  /**
   * R629 list allocate_object_list : allocate_object ( T_COMMA allocate_object
   * )*
   *
   * @param count The number of items in the list.
   */
   ...
   * @param hasUpperBound True if upper-bound-expr is present (note always
   * true).
   */
   ...
   * @param eos T_EOS token.
   */
  public abstract void nullify_stmt(Token label, Token nullifyKeyword, Token eos);
  ...
  /**
   * R635 deallocate_stmt : (label)? T_DEALLOCATE T_LPAREN allocate_object_list
  ...
  /**
   * R637-F08 list allocate_coshape_spec_list : allocate_coshape_spec ( T_COMMA
  ...
  /**
   * R705: note, moved leading optionals to mult_operand add_operand : (add_op)?
   * mult_operand (add_op mult_operand)*
   *
  ...
  /**
   * R716: note, moved leading optional to or_operand equiv_operand : or_operand
   * (equiv_op or_operand)*
   *
   ...
   */
  public abstract void where_construct(int numConstructs, boolean hasMaskedElsewhere, boolean hasElsewhere);
   ...
   * @param eos T_EOS token.
   */
  public abstract void where_construct_stmt(Token id, Token whereKeyword, Token eos);
   ...
   * @param eos T_EOS token.
   */
  public abstract void masked_elsewhere_stmt(Token label, Token elseKeyword, Token whereKeyword,
          Token id, Token eos);
   ...
   * @param eos T_EOS token.
   */
  public abstract void end_where_stmt(Token label, Token endKeyword, Token whereKeyword, Token id, Token eos);
  ...
  /**
   * R758 end_forall_stmt : (label)? T_END T_FORALL (T_IDENT)? T_EOS | (label)?
   ...
   * @param eos T_EOS token.
   */
  public abstract void end_forall_stmt(Token label, Token endKeyword, Token forallKeyword, Token id, Token eos);
   ...
   * @param eos T_EOS token.
   */
  public abstract void if_then_stmt(Token label, Token id, Token ifKeyword, Token thenKeyword, Token eos);
   ...
   * @param eos T_EOS token.
   */
  public abstract void else_if_stmt(Token label, Token elseKeyword, Token ifKeyword,
   ...
   * @param eos T_EOS token.
   */
  public abstract void end_if_stmt(Token label, Token endKeyword, Token ifKeyword, Token id, Token eos);
   ...
   * @param numDeclConstructs Number of declaration constructs.
   */
  public abstract void specification_part_and_block(int numUseStmts, int numImportStmts, int numDeclConstructs);
   ...
   */
  public abstract void block_stmt(Token label, Token id, Token keyword, Token eos);
   ...
   * @param eos The T_EOS token
   */
  public abstract void critical_stmt(Token label, Token id, Token keyword, Token eos);
   ...
   * @param eos T_EOS token.
   */
  public abstract void case_stmt(Token label, Token caseKeyword, Token id, Token eos);
   ...
   * @param eos T_EOS token.
   */
  public abstract void associate_stmt(Token label, Token id, Token associateKeyword, Token eos);
   ...
   * @param eos T_EOS token.
   */
  public abstract void select_type_stmt(Token label, Token selectConstructName, Token associateName, Token eos);

  public abstract void select_type(Token selectKeyword, Token typeKeyword);

  /**
   * R823 type_guard_stmt : (label)? T_TYPE T_IDENT T_LPAREN type_spec T_RPAREN
   * (T_IDENT)? T_EOS | (label)? T_CLASS T_IDENT T_LPAREN type_spec T_RPAREN
   * (T_IDENT)? T_EOS | (label)? T_CLASS	T_DEFAULT (T_IDENT)? T_EOS
   *
   * @param label The label.
   ...
   * @param eos T_EOS token.
   */
  public abstract void type_guard_stmt(Token label, Token typeKeyword, Token isOrDefaultKeyword,
   ...
   * @param eos T_EOS token.
   */
  public abstract void end_do_stmt(Token label, Token endKeyword, Token doKeyword, Token id, Token eos);
   ...
   * added the T_END T_DO and T_ENDDO options to this rule because of the token
   * T_LABEL_DO_TERMINAL that is inserted if they end a labeled DO.
   *
   ...
   * @param eos T_EOS token.
   */
  public abstract void cycle_stmt(Token label, Token cycleKeyword, Token id, Token eos);
   ...
   * @param eos T_EOS token.
   */
  public abstract void exit_stmt(Token label, Token exitKeyword, Token id, Token eos);
   ...
   * @param eos T_EOS token.
   */
  public abstract void goto_stmt(Token label, Token goKeyword, Token toKeyword, Token target_label, Token eos);
   ...
   * @param eos T_EOS token.
   */
  public abstract void computed_goto_stmt(Token label, Token goKeyword, Token toKeyword, Token eos);
   ...
   * @param eos T_EOS token. Note: This is a deleted feature.
   */
   ...
   * @param eos T_EOS token. Note: This is a deleted feature.
   */
  public abstract void pause_stmt(Token label, Token pauseKeyword, Token constant, Token eos);

  /**
   * R847 arithmetic_if_stmt : (label)? T_ARITHMETIC_IF_STMT T_IF T_LPAREN expr
   * T_RPAREN label T_COMMA label T_COMMA label T_EOS
   *
   ...
   * @param eos T_EOS token.
   */
  public abstract void continue_stmt(Token label, Token continueKeyword, Token eos);
   ...
   */
  public abstract void stop_stmt(Token label, Token stopKeyword, Token eos, boolean hasStopCode);
   ...
   */
  public abstract void lock_stmt(Token label, Token lockKeyword, Token eos, boolean hasLockStatList);
   ...
   */
  public abstract void unlock_stmt(Token label, Token unlockKeyword, Token eos, boolean hasSyncStatList);
  ...
  /**
   * R904 open_stmt : (label)? T_OPEN T_LPAREN connect_spec_list T_RPAREN T_EOS
   *
   * @param label The label.
  ...
  /**
   * R908 close_stmt : (label)? T_CLOSE T_LPAREN close_spec_list T_RPAREN T_EOS
   *
   * @param label The label.
   ...
   */
  public abstract void read_stmt(Token label, Token readKeyword, Token eos, boolean hasInputItemList);
   ...
   */
  public abstract void write_stmt(Token label, Token writeKeyword, Token eos, boolean hasOutputItemList);
   ...
   * @param hasOutputItemList True if output-item-list is present
   */
  public abstract void print_stmt(Token label, Token printKeyword, Token eos, boolean hasOutputItemList);

  /**
   * R913 io_control_spec : expr | T_ASTERISK | T_IDENT // {'UNIT','FMT'}
   * T_EQUALS T_ASTERISK | T_IDENT // {'UNIT','FMT'} are expr 'NML' is T_IDENT}
  ...
  /**
   * R913 list io_control_spec_list : io_control_spec ( T_COMMA io_control_spec
   * )*
   *
   * @param count The number of items in the list.
   */
   ...
   * T_LPAREN) => (label)? T_ENDFILE T_LPAREN position_spec_list T_RPAREN T_EOS
   ...
   * there is a file unit number.
   */
  public abstract void endfile_stmt(Token label, Token endKeyword, Token fileKeyword,
          Token eos, boolean hasPositionSpecList);
   ...
   * there is a file unit number.
   */
  public abstract void rewind_stmt(Token label, Token rewindKeyword, Token eos, boolean hasPositionSpecList);
  ...
  /**
   * R927 flush_stmt : ((label)? T_FLUSH T_LPAREN) => (label)? T_FLUSH T_LPAREN
   * \ flush_spec_list T_RPAREN T_EOS | ((label)? T_FLUSH) => (label)? T_FLUSH
   * file_unit_number T_EOS
   *
   * @param label The label.
   * @param flushKeyword T_FLUSH token.
   * @param eos T_EOS token.
   * @param hasFlushSpecList True if there is a flush spec list. False is there
   * is a file unit number.
   */
  public abstract void flush_stmt(Token label, Token flushKeyword, Token eos, boolean hasFlushSpecList);
  ...
  /**
   * R929 inquire_stmt : (label)? T_INQUIRE T_LPAREN inquire_spec_list T_RPAREN
   * T_EOS | (label)? T_INQUIRE_STMT_2 T_INQUIRE T_LPAREN T_IDENT T_EQUALS
   ...
   */
  public abstract void inquire_stmt(Token label, Token inquireKeyword, Token id, Token eos, boolean isType2);
  ...
  /**
   * R1010 list v_list_part v_list : (T_PLUS|T_MINUS)? T_DIGIT_STRING ( T_COMMA
   ...
   * @param eos T_EOS token.
   */
  public abstract void program_stmt(Token label, Token programKeyword, Token id, Token eos);
   ...
   * @param eos T_EOS token.
   */
  public abstract void module_stmt(Token label, Token moduleKeyword, Token id, Token eos);
   ...
   * @param hasOnly True if has an only statement, regardless of whether a list
   * is present.
   */
  public abstract void use_stmt(Token label, Token useKeyword, Token id, Token onlyKeyword, Token eos,
   ...
   */
  public abstract void rename(Token id1, Token id2, Token op1, Token defOp1, Token op2, Token defOp2);
   ...
   */
  public abstract void only(boolean hasGenericSpec, boolean hasRename, boolean hasOnlyUseName);
  ...
  /**
   * R1117-F08 submodule-stmt is SUBMODULE ( parent-identifier ) submodule-name
   *
   * @param label The label.
   ...
   * @param eos T_EOS token.
   */
  public abstract void submodule_stmt(Token label, Token submoduleKeyword, Token name, Token eos);
  ...
  /**
   * R1117 block_data_stmt : (label)? T_BLOCK T_DATA (T_IDENT)? T_EOS | (label)?
   ...
   * @param eos T_EOS token.
   */
  public abstract void end_block_data_stmt(Token label, Token endKeyword, Token blockKeyword,
          Token dataKeyword, Token id, Token eos);
   ...
   *
   * @param label The label.
   * @param abstract The ABSTRACT keyword token (null if the interface is not
   * abstract).
   ...
   * @param hasGenericSpec True if has a generic spec.
   */
  public abstract void end_interface_stmt(Token label, Token kw1,
  ...
  /**
   * R1206 procedure_stmt : (label)? ( T_MODULE )? T_PROCEDURE generic_name_list
   * T_EOS
   *
   * @param label The label.
   ...
   * @param eos T_EOS token.
   */
  public abstract void procedure_stmt(Token label, Token module, Token procedureKeyword, Token eos);
   ...
   */
  public abstract void import_stmt(Token label, Token importKeyword, Token eos, boolean hasGenericNameList);
   ...
   * @param eos T_EOS token.
   */
  public abstract void external_stmt(Token label, Token externalKeyword, Token eos);
   ...
   */
  public abstract void procedure_declaration_stmt(Token label, Token procedureKeyword,
  ...
  /**
   * R1213 proc_attr_spec : access_spec | proc_language_binding_spec | T_INTENT
   * T_LPAREN intent_spec T_RPAREN | T_OPTIONAL | T_POINTER | T_SAVE
   *
   ...
   * @param eos T_EOS token.
   */
  public abstract void intrinsic_stmt(Token label, Token intrinsicToken, Token eos);
   ...
   */
  public abstract void call_stmt(Token label, Token callKeyword, Token eos, boolean hasActualArgSpecList);
   ...
   *
   * @param keyword The keyword is the name of the dummy argument in the
   * explicit interface of the procedure.
   */
  public abstract void actual_arg_spec(Token keyword);

  /**
   * R1220 list actual_arg_spec_list : actual_arg_spec ( T_COMMA actual_arg_spec
   * )*
   *
   ...
   * was given.
   */
  public abstract void function_subprogram(boolean hasExePart, boolean hasIntSubProg);
   ...
   * statement.
   */
  public abstract void subroutine_stmt(Token label, Token keyword, Token name, Token eos,
   ...
   * end_of_stmt | (label)? T_ENDSUBROUTINE ( T_IDENT )? end_of_stmt | (label)?
   * T_END end_of_stmt
   *
   * @param label The label.
  ...
  /**
   * R1237-F08 separate-module-subprogram is mp-subprogram-stmt // NEW_TO_F2008
   ...
   */
  public abstract void separate_module_subprogram(boolean hasExecutionPart, boolean hasInternalSubprogramPart);
   ...
   * parameter list and cosubscript, sigh // ( T_LPAREN (actual_arg_spec_list)?
   * T_RPAREN )? // ( T_LBRACKET expr T_AT T_IDENT T_RBRACKET)? T_EOS
   *
   * @param label Optional statement label.
   ...
   */
  public abstract void rice_spawn_stmt(Token label, Token spawn, Token eos, boolean hasEvent);
